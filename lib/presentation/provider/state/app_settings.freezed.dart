...
class _$AppSettingsImpl implements _AppSettings {
  const _$AppSettingsImpl({required this.isAlwaysOnTop});
  ...
  @override
  String toString() {
    return 'AppSettings(isAlwaysOnTop: $isAlwaysOnTop)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, isAlwaysOnTop);
...
abstract class _AppSettings implements AppSettings {
  const factory _AppSettings({required final bool isAlwaysOnTop}) =
      _$AppSettingsImpl;
